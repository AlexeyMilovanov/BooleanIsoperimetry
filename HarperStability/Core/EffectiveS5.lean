...
noncomputable def s5_K4 (hS4 : S4Eff) (Q : QData) (hQ : validQData Q) (eps : ℝ) : ℝ :=
  max 1 (Classical.choose (hS4 Q hQ) / eps ^ 4)

lemma s5_K4_ge_one (hS4 : S4Eff) (Q : QData) (hQ : validQData Q) (eps : ℝ) :
    1 ≤ s5_K4 hS4 Q hQ eps := by
  unfold s5_K4
  exact le_max_left _ _

noncomputable def s5_foldEnv_eff (_hR3 : R3Eff) (hS4 : S4Eff) (_hS1 : S1Statement) (_hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) : ℝ :=
  s5_K4 hS4 Q hQ eps * (effEnv 5 Q.sigma m + 1)

lemma s5_foldEnv_eff_sublinear (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (_heps : 0 < eps) :
...
lemma s5_foldEnv_eff_nonneg (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) :
...
lemma s5_foldEnv_eff_spec (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
  ...
  obtain ⟨o, ho0, hoLt, h⟩ :=
    (Classical.choose_spec (hS4 Q hQ)).2 eps heps m A q hA hFat hPinned
  unfold s5_foldEnv_eff s5_K4
  have hCoeff :
      Classical.choose (hS4 Q hQ) / eps ^ 4 ≤
        max 1 (Classical.choose (hS4 Q hQ) / eps ^ 4) := le_max_right _ _
...
noncomputable def s5_baseSlack_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) : ℝ :=
  Q.sigma m + s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m

lemma s5_baseSlack_eff_sublinear (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
...
lemma s5_baseSlack_eff_nonneg (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) :
...
noncomputable def s5_atomQ_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) : QData :=
  { qMin := Q.qMin, qMax := Q.qMax, s0 := Q.s0, mu0 := Q.mu0,
    sigma := fun m =>
      Q.sigma m + Real.sqrt ((s5_baseSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) * ((m : ℝ) + 1)) }

lemma s5_atomQ_eff_valid (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
...
noncomputable def s5_K3 (hR3 : R3Eff) (_hS4 : S4Eff) (_hS1 : S1Statement) (_hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (_eps : ℝ) : ℝ :=
  Classical.choose
      (hR3 Q.qMin Q.qMax Q.s0 Q.mu0 hQ.1 hQ.2.1 hQ.2.2.1 hQ.2.2.2.1
        hQ.2.2.2.2.1 hQ.2.2.2.2.2.1) /
    (1 / 6 : ℝ)

lemma s5_K3_ge_one (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) :
    1 ≤ s5_K3 hR3 hS4 hS1 hS2 Q hQ eps := by
  unfold s5_K3
  have hK :=
    (Classical.choose_spec
      (hR3 Q.qMin Q.qMax Q.s0 Q.mu0 hQ.1 hQ.2.1 hQ.2.2.1 hQ.2.2.2.1
        hQ.2.2.2.2.1 hQ.2.2.2.2.2.1)).1
  norm_num
  nlinarith

noncomputable def s5_atomSigmaStar_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) : ℝ :=
  s5_K3 hR3 hS4 hS1 hS2 Q hQ eps * (effEnv 2 (s5_atomQ_eff hR3 hS4 hS1 hS2 Q hQ eps).sigma m + 1)

lemma s5_atomSigmaStar_eff_sublinear (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
...
lemma s5_atomSigmaStar_eff_nonneg (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) :
...
lemma s5_atomSigmaStar_eff_spec (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
    ∀ m (A : Finset (Cube m)) (q : ℝ),
  ...
  unfold s5_atomSigmaStar_eff s5_K3
  simpa [div_mul_eq_mul_div, mul_assoc] using h

noncomputable def s5_atomSlack_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) : ℝ :=
...
lemma s5_atomSlack_eff_nonneg (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) :
...
lemma s5_atomSlack_eff_ge_40 (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) :
...
lemma s5_atomSlack_eff_sublinear (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
...
noncomputable def s5_massSlack_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) : ℝ :=
  Real.sqrt ((s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) * ((m : ℝ) + 1)) +
    s5_atomSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1

lemma s5_massSlack_eff_sublinear (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
...
lemma s5_baseSlack_eff_le_grade5 (hR3 : R3Eff) (hS4 : S4Eff)
...
lemma s5_geom_base_eff_le_grade6 (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) :
    Real.sqrt
        ((s5_baseSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) *
...
lemma s5_geom2_base_eff_le_grade7 (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) :
    Real.sqrt
        ((Real.sqrt
...
lemma s5_atomSigmaStar_eff_le_grade8 (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) (eps : ℝ) (m : ℕ) :
    s5_atomSigmaStar_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
...
lemma s5_heavy_atom_fat_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
...
lemma s5_heavy_atom_pinned_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
...
lemma s5_heavy_atom_blockRegular_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
...
lemma s5_heavy_atom_E1_bound_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
    (hA : A.Nonempty) (heps : 0 < eps) (hepsQ : eps < Q.qMin)
...
lemma s5_heavy_atom_Markov_bound_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
    (hA : A.Nonempty) (heps : 0 < eps) (hepsQ : eps < Q.qMin)
...
lemma s5_heavy_atom_bad_bins_bound_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
    (hA : A.Nonempty) (heps : 0 < eps) (hepsQ : eps < Q.qMin)
...
lemma s5_heavy_atoms_bad_steps_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
    (hA : A.Nonempty) (heps : 0 < eps) (hepsQ : eps < Q.qMin)
...
lemma s5_average_bad_steps_from_heavy_atoms_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
...
lemma s5_atom_average_slack_le_massSlack_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
...
theorem s5_average_bad_steps_bound_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement)
    (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q)
    (m : ℕ) (A : Finset (Cube m)) (q eps : ℝ)
    (hA : A.Nonempty) (heps : 0 < eps) (hepsQ : eps < Q.qMin)
...
lemma s5_K4_le_raw_div_pow4 (hS4 : S4Eff) (Q : QData) (hQ : validQData Q)
    {eps : ℝ} (heps : 0 < eps) (heps1 : eps < 1) :
    s5_K4 hS4 Q hQ eps ≤ Classical.choose (hS4 Q hQ) / eps ^ 4 := by
  unfold s5_K4
  have hKraw : 1 ≤ Classical.choose (hS4 Q hQ) :=
    (Classical.choose_spec (hS4 Q hQ)).1
  have hone : 1 ≤ Classical.choose (hS4 Q hQ) / eps ^ 4 := by
    have hpos4 : 0 < eps ^ 4 := by positivity
    rw [le_div_iff₀ hpos4]
    exact (le_trans (by
      have hle : eps ^ 4 ≤ 1 := by
...
lemma s5_geom_base_eff_le_grade6_uniform (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    ...
    Real.sqrt
        ((s5_baseSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) *
          ((m : ℝ) + 1)) ≤
      ((Classical.choose (hS4 Q hQ) + 1) / eps ^ 2) *
        (effEnv 6 Q.sigma m + 1) := by
  let K4raw : ℝ := Classical.choose (hS4 Q hQ)
  let C : ℝ := K4raw + 1
  set E4 : ℝ := effEnv 5 Q.sigma m
  have hK4raw_ge : 1 ≤ K4raw := by
    dsimp [K4raw]
    exact (Classical.choose_spec (hS4 Q hQ)).1
  ...
  calc
    ...
    _ = ((Classical.choose (hS4 Q hQ) + 1) / eps ^ 2) *
          (effEnv 6 Q.sigma m + 1) := by
          dsimp [C, K4raw]

lemma s5_geom2_base_eff_le_grade7_uniform (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) {eps : ℝ}
    (heps : 0 < eps) (heps1 : eps < 1) (m : ℕ) :
    Real.sqrt
        ((Real.sqrt
            ((s5_baseSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) *
              ((m : ℝ) + 1)) + 1) * ((m : ℝ) + 1)) ≤
      ((Classical.choose (hS4 Q hQ) + 2) / eps ^ 2) *
        (effEnv 7 Q.sigma m + 1) := by
  let C : ℝ := Classical.choose (hS4 Q hQ) + 2
  set E5 : ℝ := effEnv 6 Q.sigma m
  have hChoose_ge : 1 ≤ Classical.choose (hS4 Q hQ) :=
    (Classical.choose_spec (hS4 Q hQ)).1
  have hC_ge : 1 ≤ C := by dsimp [C]; linarith
  ...
  have hG1_le :
    ...
    calc
      Real.sqrt
          ((s5_baseSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) *
            ((m : ℝ) + 1)) + 1
          ≤ ((Classical.choose (hS4 Q hQ) + 1) / eps ^ 2) * (E5 + 1) +
              (1 / eps ^ 2) * (E5 + 1) := by
  ...
  calc
    ...
    _ = ((Classical.choose (hS4 Q hQ) + 2) / eps ^ 2) *
          (effEnv 7 Q.sigma m + 1) := by
          dsimp [C]

lemma s5_atomSigmaStar_eff_le_grade8_uniform (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) {eps : ℝ}
    (heps : 0 < eps) (heps1 : eps < 1) (m : ℕ) :
    s5_atomSigmaStar_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
      s5_K3 hR3 hS4 hS1 hS2 Q hQ eps *
        ((4 * (Classical.choose (hS4 Q hQ) + 2) + 1) / eps ^ 2) *
        (effEnv 8 Q.sigma m + 1) := by
  let C : ℝ := Classical.choose (hS4 Q hQ) + 2
  have hChoose_ge : 1 ≤ Classical.choose (hS4 Q hQ) :=
    (Classical.choose_spec (hS4 Q hQ)).1
...
lemma s5_massSlack_eff_le_grade8 (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) (eps : ℝ) (heps : 0 < eps) :
    ∃ K : ℝ, 1 ≤ K ∧
      ∀ m : ℕ,
        s5_massSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
          K * (effEnv 8 Q.sigma m + 1) := by
  let K4 : ℝ := s5_K4 hS4 Q hQ eps
  let K3 : ℝ := s5_K3 hR3 hS4 hS1 hS2 Q hQ eps
  let Cbase : ℝ := K4 + 1
  let CG1 : ℝ := 2 * Cbase
  let CG2 : ℝ := 4 * Cbase
  let Catom : ℝ := CG1 + 1
  let Cstar : ℝ := K3 * (4 * Catom + 1)
  let Cinner : ℝ := CG2 + Cstar + Cbase + CG1 + 1
  let CatomSlack : ℝ := s5_sepCoeff eps Q.mu0 * Cinner + 40
  let Cmass : ℝ := s5_epsCoeff eps * (Cbase + CG1 + CatomSlack + 1)
  refine ⟨max 1 Cmass, le_max_left _ _, ?_⟩
  intro m
  set E7 : ℝ := effEnv 8 Q.sigma m
  set base : ℝ := s5_baseSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m
  set G1 : ℝ :=
    Real.sqrt ((base + 1) * ((m : ℝ) + 1))
  set G2 : ℝ := Real.sqrt ((G1 + 1) * ((m : ℝ) + 1))
  set star : ℝ := s5_atomSigmaStar_eff hR3 hS4 hS1 hS2 Q hQ eps m
  set atom : ℝ := s5_atomSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m
  have hK4_ge : 1 ≤ K4 := by
    simpa [K4] using s5_K4_ge_one hS4 Q hQ eps
  have hK3_ge : 1 ≤ K3 := by
    simpa [K3] using s5_K3_ge_one hR3 hS4 hS1 hS2 Q hQ eps
  have hCbase_nonneg : 0 ≤ Cbase := by dsimp [Cbase]; linarith
  have hCG1_nonneg : 0 ≤ CG1 := by dsimp [CG1]; nlinarith
  have hCG2_nonneg : 0 ≤ CG2 := by dsimp [CG2]; nlinarith
  have hCatom_nonneg : 0 ≤ Catom := by dsimp [Catom]; nlinarith
  have hCstar_nonneg : 0 ≤ Cstar := by dsimp [Cstar]; nlinarith
  have hCinner_nonneg : 0 ≤ Cinner := by dsimp [Cinner]; nlinarith
  have hCatomSlack_nonneg : 0 ≤ CatomSlack := by
    dsimp [CatomSlack]
    have hSep := s5_sepCoeff_nonneg eps Q.mu0
    nlinarith [mul_nonneg hSep hCinner_nonneg]
  have hE7_nonneg : 0 ≤ E7 := by
    dsimp [E7]
    exact effEnv_nonneg 8 Q.sigma hQ.2.2.2.2.2.2.1.1 m
  have hE7_one_nonneg : 0 ≤ E7 + 1 := by linarith
  have hE7_one_ge_one : 1 ≤ E7 + 1 := by linarith
  have hbase_le : base ≤ Cbase * (E7 + 1) := by
    have h4 :=
      s5_baseSlack_eff_le_grade5 hR3 hS4 hS1 hS2 Q hQ eps m
    have h47 := s5_effEnv_four_le_seven Q m
    have hE4_nonneg : 0 ≤ effEnv 5 Q.sigma m :=
      effEnv_nonneg 5 Q.sigma hQ.2.2.2.2.2.2.1.1 m
    have h4_to_7 :
        (s5_K4 hS4 Q hQ eps + 1) * (effEnv 5 Q.sigma m + 1) ≤
          Cbase * (E7 + 1) := by
      have hcoeff : 0 ≤ s5_K4 hS4 Q hQ eps + 1 := by
        linarith [s5_K4_ge_one hS4 Q hQ eps]
      have hE : effEnv 5 Q.sigma m + 1 ≤ E7 + 1 := by
        change effEnv 5 Q.sigma m + 1 ≤ effEnv 8 Q.sigma m + 1
        linarith
      simpa [Cbase, K4] using mul_le_mul_of_nonneg_left hE hcoeff
    have h4' : base ≤ (s5_K4 hS4 Q hQ eps + 1) * (effEnv 5 Q.sigma m + 1) := by
      simpa [base] using h4
    exact h4'.trans h4_to_7
  have hG1_le : G1 ≤ CG1 * (E7 + 1) := by
    have h5 :=
      s5_geom_base_eff_le_grade6 hR3 hS4 hS1 hS2 Q hQ eps m
    have h57 := s5_effEnv_five_le_seven Q m
    have h5_to_7 :
        2 * (s5_K4 hS4 Q hQ eps + 1) * (effEnv 6 Q.sigma m + 1) ≤
          CG1 * (E7 + 1) := by
      have hcoeff : 0 ≤ 2 * (s5_K4 hS4 Q hQ eps + 1) := by
        nlinarith [s5_K4_ge_one hS4 Q hQ eps]
      have hE : effEnv 6 Q.sigma m + 1 ≤ E7 + 1 := by
        change effEnv 6 Q.sigma m + 1 ≤ effEnv 8 Q.sigma m + 1
        linarith
      simpa [CG1, Cbase, K4, mul_assoc] using
        mul_le_mul_of_nonneg_left hE hcoeff
    have h5' : G1 ≤
        2 * (s5_K4 hS4 Q hQ eps + 1) * (effEnv 6 Q.sigma m + 1) := by
      simpa [G1, base] using h5
    exact h5'.trans h5_to_7
  have hG2_le : G2 ≤ CG2 * (E7 + 1) := by
    have h6 :=
      s5_geom2_base_eff_le_grade7 hR3 hS4 hS1 hS2 Q hQ eps m
    have h67 := s5_effEnv_six_le_seven Q m
    have h6_to_7 :
        4 * (s5_K4 hS4 Q hQ eps + 1) * (effEnv 7 Q.sigma m + 1) ≤
          CG2 * (E7 + 1) := by
      have hcoeff : 0 ≤ 4 * (s5_K4 hS4 Q hQ eps + 1) := by
        nlinarith [s5_K4_ge_one hS4 Q hQ eps]
      have hE : effEnv 7 Q.sigma m + 1 ≤ E7 + 1 := by
        change effEnv 7 Q.sigma m + 1 ≤ effEnv 8 Q.sigma m + 1
        linarith
      simpa [CG2, Cbase, K4, mul_assoc] using
        mul_le_mul_of_nonneg_left hE hcoeff
    have h6' : G2 ≤
        4 * (s5_K4 hS4 Q hQ eps + 1) * (effEnv 7 Q.sigma m + 1) := by
      simpa [G2, G1, base] using h6
    exact h6'.trans h6_to_7
  have hstar_le : star ≤ Cstar * (E7 + 1) := by
    have hstar :=
      s5_atomSigmaStar_eff_le_grade8 hR3 hS4 hS1 hS2 Q hQ eps m
    simpa [star, Cstar, Catom, CG1, Cbase, K3, K4, E7, mul_assoc] using hstar
  have hAtom_def :
      atom =
        s5_sepCoeff eps Q.mu0 * (G2 + star + Q.sigma m + G1 + 1) + 40 := by
    simp [atom, s5_atomSlack_eff, G2, G1, star, base, add_comm]
  have hAtom_le : atom ≤ CatomSlack * (E7 + 1) := by
    have hInner :
        G2 + star + Q.sigma m + G1 + 1 ≤ Cinner * (E7 + 1) := by
      have hsigma_le : Q.sigma m ≤ Cbase * (E7 + 1) := by
        have hsig : Q.sigma m ≤ E7 + 1 := by
          have hsig7 : Q.sigma m ≤ effEnv 8 Q.sigma m := le_effEnv 8 Q.sigma m
          linarith
        have hCbase_ge_one : 1 ≤ Cbase := by
          dsimp [Cbase]
          linarith
        exact hsig.trans (le_mul_of_one_le_left hE7_one_nonneg hCbase_ge_one)
      dsimp [Cinner]
      nlinarith
    have hSep := s5_sepCoeff_nonneg eps Q.mu0
    rw [hAtom_def]
    calc
      s5_sepCoeff eps Q.mu0 * (G2 + star + Q.sigma m + G1 + 1) + 40
          ≤ s5_sepCoeff eps Q.mu0 * (Cinner * (E7 + 1)) + 40 := by
            simpa [add_comm, add_left_comm, add_assoc] using
              add_le_add_right (mul_le_mul_of_nonneg_left hInner hSep) 40
      _ ≤ CatomSlack * (E7 + 1) := by
            dsimp [CatomSlack]
            nlinarith
  have hMass_def :
      s5_massSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m =
        Real.sqrt ((s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) * ((m : ℝ) + 1)) +
          atom + 1 := by
    simp [s5_massSlack_eff, atom, add_comm, add_left_comm]
  have hGeomFold_le_G1 :
      Real.sqrt ((s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) * ((m : ℝ) + 1)) ≤ G1 := by
    dsimp [G1, base]
    have hEnv_le_base :
        s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
  ...
  have hMass_le_Cmass :
    ...
    have hInner :
        Real.sqrt ((s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) * ((m : ℝ) + 1)) +
            atom + 1 ≤ (CG1 + CatomSlack + 1) * (E7 + 1) := by
      nlinarith
    have hCoeff_ge_one : 1 ≤ s5_epsCoeff eps := by
      dsimp [s5_epsCoeff]
      rw [if_pos heps]
      have hinv : 0 ≤ 1 / eps := by positivity
      linarith
    rw [hMass_def]
    calc
      Real.sqrt ((s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m + 1) * ((m : ℝ) + 1)) + atom + 1
          ≤ (CG1 + CatomSlack + 1) * (E7 + 1) := hInner
      _ ≤ Cmass * (E7 + 1) := by
            dsimp [Cmass]
            have hCoeffPart :
                CG1 + CatomSlack + 1 ≤
                  s5_epsCoeff eps * (Cbase + CG1 + CatomSlack + 1) := by
              nlinarith
            exact mul_le_mul_of_nonneg_right hCoeffPart hE7_one_nonneg
  exact hMass_le_Cmass.trans
    (mul_le_mul_of_nonneg_right (le_max_right (1 : ℝ) Cmass) hE7_one_nonneg)

lemma s5_massSlack_eff_le_grade8_uniform (hR3 : R3Eff) (hS4 : S4Eff)
    (hS1 : S1Statement) (hS2 : S2Statement)
    (Q : QData) (hQ : validQData Q) :
    ∃ K : ℝ, 1 ≤ K ∧
      ∀ eps : ℝ, 0 < eps → eps < Q.qMin →
        ∀ m : ℕ,
          s5_massSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
            (K / eps ^ 4) * (effEnv 8 Q.sigma m + 1) := by
  let K4raw : ℝ := Classical.choose (hS4 Q hQ)
  let K3 : ℝ := s5_K3 hR3 hS4 hS1 hS2 Q hQ 1
  let Cg1 : ℝ := K4raw + 1
  let Cg2 : ℝ := K4raw + 2
  let Cstar : ℝ := K3 * (4 * Cg2 + 1)
  let Csep : ℝ := 64 / Q.mu0 ^ 2 + 48 / Q.mu0
  let Cinner : ℝ := Cg2 + Cstar + 1 + Cg1 + 1
  let Catom : ℝ := Csep * Cinner + 40
  let Cmass : ℝ := Cg1 + Catom + 1
  refine ⟨max 1 Cmass, le_max_left _ _, ?_⟩
  intro eps heps hepsQ m
  set E7 : ℝ := effEnv 8 Q.sigma m
  set E : ℝ := E7 + 1
  set T : ℝ :=
  ...
  have hK3_ge : 1 ≤ K3 := by
    dsimp [K3]
    exact s5_K3_ge_one hR3 hS4 hS1 hS2 Q hQ 1
  ...
  have hCatom_nonneg : 0 ≤ Catom := by
    dsimp [Catom]
    nlinarith [mul_nonneg hCsep_nonneg hCinner_nonneg]
  have hCmass_nonneg : 0 ≤ Cmass := by dsimp [Cmass]; nlinarith
  have hE7_nonneg : 0 ≤ E7 := by
    dsimp [E7]
    exact effEnv_nonneg 8 Q.sigma hQ.2.2.2.2.2.2.1.1 m
  ...
  have hG1_le_sq : G1 ≤ (Cg1 / eps ^ 2) * E := by
    ...
    have hcoeff : 0 ≤ (Classical.choose (hS4 Q hQ) + 1) / eps ^ 2 := by
      positivity
    have hG1E : G1 ≤ ((Classical.choose (hS4 Q hQ) + 1) / eps ^ 2) * E := by
      have h := mul_le_mul_of_nonneg_left h57 hcoeff
      exact hG1.trans (by simpa [E] using h)
    simpa [G1, Cg1, K4raw, E] using hG1E
  have hT_le_G1 : T ≤ G1 := by
    dsimp [T, G1]
    have hEnv_le_base :
        s5_foldEnv_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
    ...
    exact Real.sqrt_le_sqrt
      (mul_le_mul_of_nonneg_right (by linarith) (by positivity))
  have hT_le_four : T ≤ (Cg1 / eps ^ 4) * E := by
    exact hT_le_G1.trans
      (hG1_le_sq.trans
  ...
  have hG2_le_sq : G2 ≤ (Cg2 / eps ^ 2) * E := by
    have hG2 :=
      s5_geom2_base_eff_le_grade7_uniform hR3 hS4 hS1 hS2 Q hQ heps heps1 m
    have h67 : effEnv 7 Q.sigma m + 1 ≤ E := by
      have h := s5_effEnv_six_le_seven Q m
      change effEnv 7 Q.sigma m + 1 ≤ effEnv 8 Q.sigma m + 1
      simpa [add_comm] using add_le_add_right h 1
    have hcoeff : 0 ≤ (Classical.choose (hS4 Q hQ) + 2) / eps ^ 2 := by
      positivity
    have hG2E : G2 ≤ ((Classical.choose (hS4 Q hQ) + 2) / eps ^ 2) * E := by
      have h := mul_le_mul_of_nonneg_left h67 hcoeff
      exact hG2.trans (by simpa [E] using h)
    simpa [G2, G1, Cg2, K4raw, E] using hG2E
  ...
  have hstar_le_sq : star ≤ (Cstar / eps ^ 2) * E := by
    have hstar :=
      s5_atomSigmaStar_eff_le_grade8_uniform hR3 hS4 hS1 hS2 Q hQ heps heps1 m
    have hK3eq : s5_K3 hR3 hS4 hS1 hS2 Q hQ eps = K3 := by
      rfl
    have hstar' :
        star ≤ K3 * (((4 * Cg2 + 1) / eps ^ 2) * E) := by
      simpa [star, Cg2, K4raw, E, hK3eq, mul_assoc] using hstar
    calc
      star ≤ K3 * (((4 * Cg2 + 1) / eps ^ 2) * E) := hstar'
      _ = (Cstar / eps ^ 2) * E := by
          dsimp [Cstar]
          ring
  ...
  have hAtom_def :
    ...
    simp [atom, s5_atomSlack_eff, G2, G1, star, add_comm]
  ...
  have hMass_def :
    ...
    simp [s5_massSlack_eff, T, atom, add_comm, add_left_comm]
  have hMass_le :
      s5_massSlack_eff hR3 hS4 hS1 hS2 Q hQ eps m ≤
        (Cmass / eps ^ 4) * E := by
    rw [hMass_def]
...
theorem s5_eff (hR3 : R3Eff) (hS4 : S4Eff) (hS1 : S1Statement) (hS2 : S2Statement) : S5Eff := by
  intro Q hQ
  obtain ⟨K, hK, hKbound⟩ :=
    s5_massSlack_eff_le_grade8_uniform hR3 hS4 hS1 hS2 Q hQ
  refine ⟨K, hK, ?_⟩
  intro eps heps hepsQ m A q hA hFat hPinned
  exact averageBadStepsLE_mono_slack A (hKbound eps heps hepsQ m)
    (s5_average_bad_steps_bound_eff hR3 hS4 hS1 hS2 Q hQ m A q eps hA heps
      hepsQ hFat hPinned)
